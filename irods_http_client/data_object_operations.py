...
class DataObjects:
	"""Perform data object operations via iRODS HTTP API."""
	...
	def touch(
		...
		Args:
		    ...
		    no_create: Set to 1 to prevent creating a new object, otherwise set to 0.
		...
		r = requests.post(self.url_base + "/data-objects", headers=headers, data=data, timeout=30)
	...
	def calculate_checksum(
		...
		Args:
		    ...
		    resource: The resource holding the existing replica.
		    replica_number: The replica number of the target replica.
	...
	def stat(self, lpath: str, ticket: str = ""):
		...
		r = requests.get(self.url_base + "/data-objects", params=params, headers=headers, timeout=30)
		return common.process_response(r)
	...
	def register(
		...
		Args:
		    ...
		    data_size: The size of the replica in bytes.
		    checksum: The checksum to associate with the replica.
	...
	def write(
		...
		Args:
		    ...
		    resource: The root resource to write to.
		    offset: The number of bytes to skip. Defaults to 0.
		    ...
		    parallel_write_handle: The handle to be used when writing in parallel.
		    stream_index: The stream to use when writing in parallel.
	...
	def modify_replica(
		...
		Args:
		    ...
		    resource_hierarchy: The hierarchy containing the resource to be modified.
		      Mutually exclusive with replica_number.
		    replica_number: The number of the replica to be modified. mutually exclusive with
		      resource_hierarchy.
		    new_data_checksum: The new checksum to be set.
		    new_data_comments: The new comments to be set.
		    new_data_create_time: The new create time to be set.
		    new_data_expiry: The new expiry to be set.
		    new_data_mode: The new mode to be set.
		    new_data_modify_time: The new modify time to be set.
		    new_data_path: The new path to be set.
		    new_data_replica_number: The new replica number to be set.
		    new_data_replica_status: The new replica status to be set.
		    new_data_resource_id: The new resource id to be set.
		    new_data_size: The new size to be set.
		    new_data_status: The new data status to be set.
		    new_data_type_name: The new type name to be set.
		    new_data_version: The new version to be set.
