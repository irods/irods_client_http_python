...
test_config = {
	...
	"host": "localhost",
	"port": 9001,
	"url_base": "/irods-http-api/0.6.0",
	"rodsadmin": {"username": "rods", "password": "rods"},
	"rodsuser": {"username": "jeb", "password": "ding"},
	"irods_zone": "tempZone",
...
schema = {
	...
	"properties": {
		...
		"rodsadmin": {"$ref": "#/definitions/login"},
		"rodsuser": {"$ref": "#/definitions/login"},
		"irods_zone": {"type": "string"},
		"irods_server_hostname": {"type": "string"},
	},
	"required": [
		"host",
		"port",
